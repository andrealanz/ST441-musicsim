...
generate_ly(map(notes[samp1], ~ (sine(.))), bars = 2) #generate a .ly file for the sampled notes
```

It appears that the higher notes are selected more often, providing evidence that our Markov chain implementation is indeed working.
