...
```{r}
lilyinput(qlily, file = "wspec.ly")
```

When played, the output should be two notes, one of which is an octave above the other. The plots generated above should reflect this.
